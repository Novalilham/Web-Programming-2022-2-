        ...
        <div id="carouselThree" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets/images/slider/1.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets/images/slider/2.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?=base_url()?>assets/images/slider/3.png" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
            </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row no-gutters grid mt-50">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/1.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/2.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/3.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/4.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/5.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                            ...
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    ...
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/6.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets/images/portfolio/7.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/7.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets/images/portfolio/8.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/8.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?=base_url()?>assets/images/portfolio/9.png" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?=base_url()?>assets/images/portfolio/9.png"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?=base_url()?>assets/images/portfolio/shape.svg" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets/images/basic.svg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets/images/pro.svg" alt="">
                        </div>
                        <div class="pricing-header text-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?=base_url()?>assets/images/enterprise.svg" alt="">
                        </div>
                        <div class="pricing-header text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="about-image mt-50">
                        <img src="<?=base_url()?>assets/images/about.jpg" alt="about">
                    </div> <!-- faq image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.3171986746206!2d106.83028601370034!3d-6.352966295402683!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec6b07b68ea5%3A0x17da46bdf9308386!2sSTT%20Terpadu%20Nurul%20Fikri%20-%20Kampus%20B!5e0!3m2!1sid!2sid!4v1654667130993!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div> <!-- row -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4   ">
                    <div class="footer-logo text-center">
                        <a class="mt-5" href="#"><img src="<?=base_url()?>dist/img/val2.png" style="width: 150px;height: 150px;" alt="Logo"></a>
                    </div> <!-- footer logo -->
                    <ul class="social text-center mt-10">
                    ...
                    <div class="footer-support text-center">
                        ...
                        <span class="mail">nvilham29@gmail.com</span>
                    </div>
                </div>
            </div> <!-- row -->
        </div>
