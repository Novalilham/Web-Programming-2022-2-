...
<?php echo form_open('mahasiswa/savedosen') ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="tmp_lahir" name="tmp_lahir" placeholder="Masukkan Tempat Lahir" value="<?php echo $obj_dosen->tmp_lahir?>" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
