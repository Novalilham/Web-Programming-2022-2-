...
error_reporting(0);
$pasien = array(
    1 => array(1, "2022-01-9", "P001", "Udin", "Pria", 69.8, 169, 24.7, "Kelebihan Berat Badan"),
        array(2, "2022-02-10", "P002", "Reni Amelia", "Wanita", 55.3, 165, 20.3, "Sehat (Ideal)"),
        array(3, "2022-03-11", "P003", "Ryan", "Pria", 45.2, 171, 15.4, "Kekurangan Berat Badan")
    );
